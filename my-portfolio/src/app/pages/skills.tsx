...
const SkillsPage = () => {
    ...
    return (
        <>
            ...
            <div className="w-full h-screen align-middle p-5 overflow-y-auto">
                <div className="flex flex-wrap gap-2 justify-between">
                    <div className="bg-gradient-to-r from-[#1b295e]/60 to-[#1b295e]/30 p-10 rounded-lg grow-0">
                    ...
                    {stacks.map(stack => (
                        <div className={`bg-gradient-to-r from-[#1b295e]/60 to-[#1b295e]/30 rounded-lg flex flex-col items-center mt-5 ${stack.grid}`} key={stack.category}>
